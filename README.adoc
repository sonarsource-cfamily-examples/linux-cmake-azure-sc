...
:uri-build-status: https://dev.azure.com/sc-sq-c-family-examples/linux-cmake-azure-sc/_build/latest?definitionId=2
:img-build-status: https://dev.azure.com/sc-sq-c-family-examples/linux-cmake-azure-sc/_apis/build/status/sc-sq-c-family-examples.linux-cmake-azure-sc
